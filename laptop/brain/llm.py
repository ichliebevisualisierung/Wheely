...
class Brain:
    ...
    def decide(self, goal, perception, available_actions, history=None, memory_context=None):
        ...
        system = (
            ...
            "Hoechste Prioritaet: Bewerte immer das vollstaendige Nutzerziel. "
            "Bei reinen Suchzielen ist das Ziel erreicht, wenn das gesuchte Objekt "
            "in der aktuellen Wahrnehmung oder Bildbeschreibung sichtbar/erwaehnt ist; "
            "dann antworte mit {\"name\": \"done\"}. Wenn das Ziel aber verlangt, "
            "zu dem Objekt zu fahren, ihm entgegenzufahren oder es zu erreichen, "
            "ist Sichtkontakt nur ein Zwischenziel. Dann fahre oder orientiere dich "
            "weiter zum Objekt und antworte erst mit {\"name\": \"done\"}, wenn "
            "das vollstaendige Ziel erreicht ist. Erkenne Pluralformen und "
            "offensichtliche Tippfehler im Ziel. "
            "Wenn du auf Objekte zufahren willst, beachte die Bildbeschreibung wo diese Objekte sind (links, rechts, mitte etc.)"
            "Vertraue nicht 100 prozent auf den Ultraschall-Sensor, sondern nutze die Bildbeschreibung, um Hindernisse zu erkennen und den Abstand selbst einzuschätzen. "
            "Nutze den gespeicherten Plan aus dem Session-Memory als Orientierung. "
            "Wenn die History einen goal_check oder done_rejected mit done=false "
            "enthaelt, ist das Ziel noch nicht erreicht; antworte dann nicht mit "
            "{\"name\": \"done\"}, sondern waehle eine Aktion fuer den offenen Teil. "
    ...
    def goal_reached(self, goal, perception):
        ...
        system = (
            ...
            "Bewerte immer das vollstaendige Nutzerziel, nicht nur einen Teil davon. "
            "Bei reinen Suchzielen reicht es, wenn das gesuchte Objekt in der "
            "aktuellen Wahrnehmung oder Bildbeschreibung sichtbar/erwaehnt ist. "
            "Wenn das Ziel aber verlangt, zu dem Objekt zu fahren, ihm entgegenzufahren "
            "oder es zu erreichen, ist Sichtkontakt nur ein Zwischenziel und noch "
            "nicht done. Dann ist done nur true, wenn die Wahrnehmung klar zeigt, "
            "dass der Rover das Objekt erreicht hat oder direkt davor steht. "
            "Woerter wie fahre, fahren, entgegen, zu ihr, zu ihm, zu dem Objekt "
            "oder erreichen bedeuten: Nur sehen reicht NICHT fuer done. "
            "Beispiel: Ziel 'suche das Objekt' + Bild zeigt das Objekt => done true. "
            "Beispiel: Ziel 'suche das Objekt und fahre ihm entgegen' + Bild zeigt "
            "das Objekt nur in der Szene => done false. "
            "Beruecksichtige Pluralformen und offensichtliche Tippfehler im Ziel. "
